...
#cargar background
asset_background = resource_path('assets/images/alien/background_alienwar.jpg')
background = pygame.image.load(asset_background)

#cargar icono
asset_icon = resource_path('assets/images/alien/alienwar_icon.png')
...
#cargar imagen nave
asset_player = resource_path('assets/images/alien/ufo.png')
playerimg = pygame.image.load(asset_player)

#cargar imagen enemigos
asset_enemy1 = resource_path('assets/images/alien/enemy1.png')
enemy1 = pygame.image.load(asset_enemy1)
asset_enemy2 = resource_path('assets/images/alien/enemy2.png')
enemy2 = pygame.image.load(asset_enemy2)

#cargar imagen disparo
asset_bullet = resource_path('assets/images/alien/bullet.png')
